...
<figure class="blog-article-figure"><img src="/blog/taco-kicks/taco-kicks.jpg" alt="Taco Kicks custom shoes with Two Tacos and a Hike artwork" loading="lazy" width="1400" height="788" /></figure>
...
<figure class="blog-article-figure"><img src="/blog/taco-kicks/taco-kicks-design.jpg" alt="Two Tacos and a Hike custom artwork used on the Taco Kicks" loading="lazy" width="1200" height="1200" /></figure>
...
<p>And if you have a brand, a joke, or a pattern stuck in your head: open the design tool and make your own pair. We will be here cheering when they land.</p>$html$,
  ...
  'Taco Kicks: Custom Shoes for Two Tacos & a Hike | Step Weave',
